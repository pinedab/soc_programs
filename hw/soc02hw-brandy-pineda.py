...
# # 8. UNSOLVED - There is one small bug in the continent counter below.
...
# Optional / Advanced
# 12. Do Python the Hard Way ex. 39 exercises

# 13. Mapping with cities and states/regions in your country 
# or some other country.Find the Python documentation for 
# dictionaries and try to do even more things to them.
# Find out what you can't do with dictionaries. A big one 
# is that they do not have order, so try playing with that.

# Testing
# 14. Write a test to check the outcome of the 
# alice_in_wonderfland task: one test for list of lists,
# and one test for dictionary output.